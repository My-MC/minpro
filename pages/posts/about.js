  ...
  return (
    <div>
      ...
      <main>
        ...
        <h2 className={styles.description}>こんにちは</h2>
        <div className={styles.container}>
          <article className={styles.article}>
            <h2 className={styles.heading}>挨拶</h2>
            <p>こんにちはMyです。</p>
            <p>
              このサイトは僕がJavaScriptを勉強しながら僕がのんびりと更新していく予定です。
            </p>
            ...
            <p>
              私はこのサイトをGitHubに上げています。つまりそれは誰でも読める誰でも改変できるということです。
            </p>
            <p>
              つまり言いたいことは、
            ...
            <p className={styles.linethrough}>
              ...
              <a
                href="https://github.com/My-MC/minpro/blob/master/package.json"
                target="_blank"
                rel="noopener noreferrer"
              >
                こちら
